          ...
          <div className="relative w-full md:order-2">
            ...
            <div className="relative rounded-2xl overflow-hidden group cursor-pointer mt-3 mr-2 sm:mt-0 sm:mr-0"
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className={`w-12 h-12 sm:w-16 sm:h-16 rounded-full border-2 flex items-center justify-center backdrop-blur-sm transition-all duration-300 /40 border-white/30 group-hover:bg-emerald-500/40 group-hover:border-emerald-400/80`}>
