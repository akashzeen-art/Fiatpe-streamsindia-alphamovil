            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className={`absolute top-1.5 right-1.5 p-1 rounded-full backdrop-blur-sm border transition-all ${liked.has(card.id) ? 'bg-red-500/30 border-red-500/60' : '/50 border-white/20'}`}
                >
