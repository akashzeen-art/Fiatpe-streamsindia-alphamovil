...
const cards = [
  { id: '1',  title: 'The Last Deal',            thumbnail: '/potrait_new_desicontent/63.png', category: 'Crime',    year: '2024', rating: '9.9' },
  { id: '2',  title: 'The Crime Circle',         thumbnail: '/potrait_new_desicontent/64.png', category: 'Crime',    year: '2024', rating: '9.7' },
  { id: '3',  title: 'Secret Nights',            thumbnail: '/potrait_new_desicontent/65.png', category: 'Thriller', year: '2024', rating: '9.8' },
  { id: '4',  title: 'Mission Darknight',        thumbnail: '/potrait_new_desicontent/66.png', category: 'Action',   year: '2024', rating: '9.6' },
  { id: '5',  title: 'Adventure Ke Raaz',        thumbnail: '/potrait_new_desicontent/67.png', category: 'Drama',    year: '2024', rating: '9.7' },
  { id: '6',  title: 'Killer Instinct',          thumbnail: '/potrait_new_desicontent/68.png', category: 'Thriller', year: '2024', rating: '9.5' },
  { id: '7',  title: 'Escape Route 21',          thumbnail: '/potrait_new_desicontent/69.png', category: 'Action',   year: '2024', rating: '9.9' },
  { id: '8',  title: 'Black Signal',             thumbnail: '/potrait_new_desicontent/70.png', category: 'Mystery',  year: '2024', rating: '9.8' },
  { id: '9',  title: 'Rogue Nation',             thumbnail: '/potrait_new_desicontent/71.png', category: 'Action',   year: '2024', rating: '9.6' },
  { id: '10', title: 'Silent Witness',           thumbnail: '/potrait_new_desicontent/72.png', category: 'Crime',    year: '2024', rating: '9.7' },
  { id: '11', title: 'Hidden Fear Ep1',          thumbnail: '/potrait_new_desicontent/73.png', category: 'Thriller', year: '2024', rating: '9.8' },
  { id: '12', title: 'Hidden Fear Ep2',          thumbnail: '/potrait_new_desicontent/74.png', category: 'Thriller', year: '2024', rating: '9.5' },
];
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className={`absolute top-2 right-2 p-1.5 rounded-full backdrop-blur-sm border transition-all ${liked.has(card.id) ? 'bg-red-500/30 border-red-500/60' : '/50 border-white/20'}`}
                >
