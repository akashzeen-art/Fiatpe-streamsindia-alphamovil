...
const items = [
  { rank: 1,  title: 'The Wanted Target',        genre: 'Crime',    rating: '5.0', duration: '46 min', img: '/potrait_new_desicontent/53.png' },
  { rank: 2,  title: 'Wanted by Darkness',       genre: 'Thriller', rating: '4.9', duration: '48 min', img: '/potrait_new_desicontent/54.png' },
  { rank: 3,  title: 'Unknown Enemy Ep1',        genre: 'Action',   rating: '4.9', duration: '37 min', img: '/potrait_new_desicontent/55.png' },
  { rank: 4,  title: 'Unknown Enemy Ep2',        genre: 'Action',   rating: '4.8', duration: '39 min', img: '/potrait_new_desicontent/56.png' },
  { rank: 5,  title: 'Unknown Enemy Ep3',        genre: 'Action',   rating: '4.8', duration: '41 min', img: '/potrait_new_desicontent/57.png' },
  { rank: 6,  title: 'The Shadow Game Ep1',      genre: 'Thriller', rating: '4.7', duration: '43 min', img: '/potrait_new_desicontent/58.png' },
  { rank: 7,  title: 'The Shadow Game Ep2',      genre: 'Thriller', rating: '4.7', duration: '44 min', img: '/potrait_new_desicontent/59.png' },
  { rank: 8,  title: 'The Shadow Game Ep3',      genre: 'Thriller', rating: '4.6', duration: '45 min', img: '/potrait_new_desicontent/60.png' },
  { rank: 9,  title: 'The Shadow Game Ep4',      genre: 'Thriller', rating: '4.6', duration: '46 min', img: '/potrait_new_desicontent/61.png' },
  { rank: 10, title: 'The Fitness Trap',         genre: 'Drama',    rating: '4.5', duration: '40 min', img: '/potrait_new_desicontent/62.png' },
];

const genreColor: Record<string, string> = {
  Crime: 'text-rose-400', Thriller: 'text-red-400', Action: 'text-orange-400', Drama: 'text-purple-400',
};
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <motion.div className="flex items-center gap-3 mb-8 md:mb-10"
          ...
          <div>
            ...
            <p className="text-gray-400 text-xs sm:text-sm mt-1">Titles our team personally loves</p>
